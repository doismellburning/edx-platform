...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseOverview.tabs'
        db.add_column('course_overviews_courseoverview', 'tabs',
                      self.gf('xmodule_django.models.StringListField')(default=[]),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseOverview.tabs'
        db.delete_column('course_overviews_courseoverview', 'tabs')
    ...
    models = {
        'course_overviews.courseoverview': {
            ...
            'tabs': ('xmodule_django.models.StringListField', [], {}),
